...
<?php
        ...
        {  
          ...
          <html>
          <head>
            <h1> <center><?php echo ' Welcome'."   ".$row['Firstname'];?></center><br>
        <?php
      }
        else
        {
...
<div class="sidebar">
  ...
  <a href="page1cpp.php">C++</a>
  <a href="page1j.php">Java</a>
  <a href="python1.php">Python</a>
...
function showSlides() {
 ...
 <footer>
            <h5 class="text-center"> &All Rights Rserved </h5> 
         </footer>
</html>
